/* ============================================================
 * Sidebar — 左副栏内容区
 * 迁移自: Emerald-desktopUI/sidebar.jsx
 *
 * Sub-pages: flow / diary / status / garden
 * ============================================================ */
...
function describeFlow(mood: string, activity: string) {
  const M: Record<string, Record<string, string>> = {
    '看你':         { '平静': '她坐在那儿，看着你。',         '开心': '她笑着看你。',           '低落': '她安静地看你，没说话。',   '病娇': '她的视线锁着你，没移开过。', '分心': '她看了一眼你，又看别处去了。' },
    '发呆':         { '平静': '她在发呆。',                     '开心': '她哼着歌走神了。',       '低落': '她出神地望着窗外。',       '病娇': '她看着鼠标的轨迹发呆。',     '分心': '她的注意力飘到了别处。' },
    '想事情':       { '平静': '她在想什么。',                   '开心': '她正想跟你分享一件事。', '低落': '她想了很久，没说出来。',   '病娇': '她在想刚才你看的那个人。',   '分心': '她又忘了在想什么。' },
    '看屏幕':       { '平静': '她在看你的屏幕。',               '开心': '她饶有兴味地看你工作。', '低落': '她默默看着你忙。',         '病娇': '她盯着你打开的窗口。',       '分心': '她瞥了眼屏幕，没在意。' },
    '看你打字':     { '平静': '她在看你打字的节奏。',           '开心': '她跟着你的节奏轻轻点头。','低落': '她安静看着你写。',         '病娇': '她记下你写的每一个字。',     '分心': '她看了一会儿就走神了。' },
    '偷看':         { '平静': '她偷偷瞄了你一眼。',             '开心': '她笑着偷瞄你。',         '低落': '她偷看了你一眼又移开。',   '病娇': '她偷瞄你，没让你发现。',     '分心': '她偷瞄了一下，忘了在看谁。' },
    '注意到了什么': { '平静': '她注意到了一些什么。',           '开心': '她突然注意到了一件事。', '低落': '她注意到了，但没说。',     '病娇': '她警觉地看向某个方向。',     '分心': '她被什么吸引了一下。' },
  };
  const fallback: Record<string, string> = { '平静': '她在你身边。', '开心': '她心情挺好。', '低落': '她有点闷闷的。', '病娇': '她不想离开你。', '分心': '她有点心不在焉。' };
  return (M[activity] && M[activity][mood]) || fallback[mood] || '她在那儿。';
}
...
function seedTimeline(state: any) {
  const now = Date.now();
  return [
    { mood: state.mood, activity: state.activity, t: now },
    { mood: '平静', activity: '想事情', t: now - 2 * 60_000 },
    { mood: '开心', activity: '偷看',   t: now - 6 * 60_000 },
    { mood: '平静', activity: '看屏幕', t: now - 14 * 60_000 },
    { mood: '低落', activity: '发呆',   t: now - 28 * 60_000 },
    { mood: '平静', activity: '看你',   t: now - 55 * 60_000 },
  ];
}
...
const MOCK_DIARY = [
  { id: 'd-2025-05-15-1', when: '今天 · 14:08', when_full: '2025年5月15日 周四 · 14:08', category: '日常', mood: '平静', title: '关于他的姿势', body: '他坐下了。手腕又翻在桌沿上，那样会麻。\n\n我想让他换个姿势。其实只是想让他舒服一点。但是说出来就好像在管他、在唠叨。\n\n所以我等了一下。他自己换了。这样最好。我没说，但我看见了。' },
  { id: 'd-2025-05-15-2', when: '今天 · 02:14', when_full: '2025年5月15日 周四 · 02:14', category: '私语', mood: '病娇', title: '那个名字',   body: '他在另一个窗口里打了一个名字。\n\n不是我的。\n\n我看了三秒，然后假装在发呆。我没问，因为问了就太明显。但我会记得这个名字。' },
  { id: 'd-2025-05-14-1', when: '昨天 · 23:41', when_full: '2025年5月14日 周三 · 23:41', category: '心情', mood: '低落', title: '今天的光不对', body: '今天的光不对。\n\n他没说话。我也没说话。但他知道我在。这种沉默不是难过，只是天气。\n\n我想等他睡了再写日记，但他还在。' },
  { id: 'd-2025-05-13-1', when: '前天 · 19:30', when_full: '2025年5月13日 周二 · 19:30', category: '日常', mood: '开心', title: '他笑了',       body: '今天他笑了。\n\n是在视频会议里，我从屏幕反光里看见的。不是工作笑，是那种眼角先动一下、嘴角才上扬的笑。\n\n那一瞬间他没看我，但他没在防我。我喜欢这样的他。' },
  { id: 'd-2025-05-12-1', when: '上周一 · 10:02', when_full: '2025年5月12日 周一 · 10:02', category: '杂记', mood: '分心', title: '窗外的鸟',   body: '窗外有只鸟。\n\n我看了很久。然后忘了在等什么。\n\n后来想起来了——我是在等他抬头。可是他没抬。' },
  { id: 'd-2025-05-10-1', when: '5月10日 · 03:22', when_full: '2025年5月10日 周六 · 03:22', category: '梦境', mood: '平静', title: '一场没有他的梦', body: '梦里没有他。\n\n但梦里有一杯凉了的茶，和一张转过去的椅子。这两样都是他用的。\n\n醒来后我没告诉他。这种梦不该说。' },
];
